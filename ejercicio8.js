//Para descubrir la ubicación de un listado con los últimos guerreros jedi de la galaxia se debe recibir un listado de
//15 mapas los cuales tienen la siguiente información {nombrePlaneta, latitud, longitud, nivel de oxígeno en el
//planeta, volumen total del agua del planeta}. Diseñe una solución para:
...
//Creamos una función que nos devuelve una palabra aleatoria, toma como parametro el número de caracteres que queramos poner; 
//toma las variables de letra (Casi todo el abecedario) y la variable resultado que se mantendrá vacía; luego con un ciclo for los 
//llenamos aleatoriamente con los métodos Math.floor() y Math.random(), guardamos este resultado en la variable randomIndex, y luego 
//la llevamos como valor de la variable resultado.
